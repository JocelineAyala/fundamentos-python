'''
Clase:        Clase 10
Tema:         Instrucción al manejo de datos tabulares con NumPy
Ejercicio:    5. Cuestionario de trabajo
Descripción:  Responde cada pregunta escribiendo el código necesario para obtener la repuesta.
...
print("Consunmo el miércoles (día 3):", consumo[:, 2])

# Promodio de consumo por hogar
...
# Aplicando normalización MinMax al consumo de datos
consumo_normalizado = (consumo.min()) / (consumo.max() - consumo.min())
...
print("1. Consumo hogar 5 el viernes (día 5):", consumo[4,4])

# 2. Usando indexación, muestra el consumo de los últimos 3 hogares el domingo.
ultimos_3_hogares_domingo = consumo[-3:, 6]
print("2. Consumo de los últimos 3 hogares domingo:", ultimos_3_hogares_domingo)
...
print("3. Promedio de consumo de fin de semanas:", promedio_fin_semana)
...
dia_mayor_desviacion = np.argmax(np.std(consumo, axis=0))
print("4. Desviación estándar por día:", desviacion_estandar_dia)
print("4.1 El día de la semana con mayor desviación estándar entre hogares es:", dia_mayor_desviacion)
...
print("5. índices 3 hogares con menor consumo:", indices_menores)
print(" 5.1 Valores de consumo:", valores_menores)
...
nuevo_total = np.sum(nuevo_hogar3)
print("6. Nuevo consumo total hogar 3 con aumento de 10%:", nuevo_total)
